...
import IngressTraitsTab from '@/components/verrazzano/ApplicationComponentsTab/IngressTraitsTab';
import LabeledInput from '@/components/form/LabeledInput';
import LabeledSelect from '@/components/form/LabeledSelect';
import LoggingTraitTab from '@/components/verrazzano/ApplicationComponentsTab/LoggingTraitTab';
import ManualScalerTraitTab from '@/components/verrazzano/ApplicationComponentsTab/ManualScalerTraitTab';
import MetricsTraitTab from '@/components/verrazzano/ApplicationComponentsTab/MetricsTraitTab';
