...
import DownwardAPIVolumeFile from '@/components/verrazzano/Volumes/DownwardAPI/DownwardAPIVolumeFile';
  ...
  <div>
      ...
      <div class="row">
        <div class="col span-6">
          <LabeledInput
            ...
            :mode="mode"
            :label="t('verrazzano.config.fields.volumes.downwardApi.defaultMode')"
    ...
    <div>
      <ArrayListGrouped
        ...
        :mode="mode"
        :default-add-value="{ }"
        :add-label="t('verrazzano.config.buttons.addDownwardApiVolumeFile')"
        @add="addFile()"
      >
