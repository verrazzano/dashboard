  ...
  <div>
    <div class="row">
      <div class="col span-3">
        <LabeledInput
          ...
          :mode="mode"
          required
          :label="t('verrazzano.config.fields.volumes.flex.driver')"
      ...
      <div class="col span-3">
        <LabeledInput
          ...
          :mode="mode"
          :label="t('verrazzano.config.fields.volumes.flex.fsType')"
      ...
      <div class="col span-3">
        <LabeledSelect
          ...
          :label="t('verrazzano.config.fields.volumes.flex.secretRefName')"
      ...
      <div class="col span-3">
        <Checkbox
          ...
          :mode="mode"
          :label="t('verrazzano.config.fields.volumes.flex.readOnly')"
    ...
    <div>
      <LabeledArrayList
        ...
        :mode="mode"
        :value-label="t('verrazzano.config.fields.volumes.flex.option')"
        :add-label="t('verrazzano.config.buttons.addFlexVolumeOption')"
        initial-empty-row
