    ...
    <div class="row">
      <div class="col span-4">
        ...
        <div v-else>
          <LabeledSelect
            ...
            :label="t('verrazzano.config.fields.volumes.secret.name')"
      ...
      <div v-if="showDefaultMode" class="col span-4">
        <LabeledInput
          ...
          :mode="mode"
          :label="t('verrazzano.config.fields.volumes.secret.defaultMode')"
      ...
      <div class="col span-4">
        <Checkbox
          ...
          :mode="mode"
          :label="t('verrazzano.config.fields.volumes.secret.optional')"
