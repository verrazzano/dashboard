...
import OAMConfigFile
  from '@/edit/core.oam.dev.component/ContainerizedWorkload/OAMContainersTab/OAMConfigFilesTab/OAMConfigFile';
...
<template>
  <TreeTab :name="treeTabName" :label="treeTabLabel">
    <template #beside-header>
      <TabDeleteButton
        :element-name="t('verrazzano.containerized.tabs.configFiles')"
        :mode="mode"
