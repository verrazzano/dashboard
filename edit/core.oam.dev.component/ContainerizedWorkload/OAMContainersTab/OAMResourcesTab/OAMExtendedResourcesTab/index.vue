...
import OAMExtendedResource
  from '@/edit/core.oam.dev.component/ContainerizedWorkload/OAMContainersTab/OAMResourcesTab/OAMExtendedResourcesTab/OAMExtendedResource';
...
<template>
  <TreeTab :name="treeTabName" :label="treeTabLabel">
    <template #beside-header>
      <TabDeleteButton
        :element-name="t('verrazzano.containerized.tabs.extendedResources')"
        :mode="mode"
