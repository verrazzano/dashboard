...
import OAMExtendedResourcesTab
  from '@/edit/core.oam.dev.component/ContainerizedWorkload/OAMContainersTab/OAMResourcesTab/OAMExtendedResourcesTab';
import OAMVolumesTab
  from '@/edit/core.oam.dev.component/ContainerizedWorkload/OAMContainersTab/OAMResourcesTab/OAMVolumesTab';
...
<template>
  <TreeTab :name="treeTabName" :label="treeTabLabel">
    <template #beside-header>
      <TabDeleteButton
        :element-name="t('verrazzano.common.tabs.resources')"
        :mode="mode"
