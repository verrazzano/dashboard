...
export default {
  ...
  methods: {
    getWorkloadDeploymentTemplateField(fieldName) {
      const pathName = fieldName
        ? `spec.workload.spec.deploymentTemplate.${fieldName}`
        : "spec.workload.spec.deploymentTemplate";

      return this.getField(pathName);
    },
    getWorkloadDeploymentTemplateMetadataField(fieldName) {
      const pathName = fieldName
        ? `spec.workload.spec.deploymentTemplate.metadata.${fieldName}`
        : "spec.workload.spec.deploymentTemplate.metadata";
    ...
    getWorkloadPodSpecField(fieldName) {
      const pathName = fieldName
        ? `spec.workload.spec.deploymentTemplate.podSpec.${fieldName}`
        : "spec.workload.spec.deploymentTemplate.podSpec";

      return this.getField(pathName);
    },
    getWorkloadPodSpecMetadataField(fieldName) {
      const pathName = fieldName
        ? `spec.workload.spec.deploymentTemplate.podSpec.metadata.${fieldName}`
        : "spec.workload.spec.deploymentTemplate.podSpec.metadata";
